...
<div id="page" class="site">
	...
	<?php do_action( 'alcatraz_before_header' );
		...
		$background_image_url = wp_get_attachment_image_src( $background_image_id, 'full', false );

	?>

	<div class="header-background" style="background-image: url('<?php echo $background_image_url[0] ?>');">
